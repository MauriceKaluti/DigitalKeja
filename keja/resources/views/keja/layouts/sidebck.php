 <div class="offcanvas offcanvas-start lmsapp-offcanvas-wrap" tabindex="-1" id="lmsappOffcanvas" aria-labelledby="lmsappOffcanvasLabel">
      <!-- Close button-->
      ...
      <div class="offcanvas-body">
        ...
        <div class="sidenav-profile">
          ...
          <div class="user-info">
            <h6 class="user-name mb-1">LMS Sarah</h6>
        ...
        <ul class="sidenav-nav ps-0">
          ...
          <li class="lmsapp-dropdown-menu"><a href="#"><i class="lni lni-cart"></i>Shop Pages</a>
            <ul>
          ...
          <li class="lmsapp-dropdown-menu"><a href="wishlist-grid.html"><i class="lni lni-heart"></i>My Wishlist</a>
            <ul>
