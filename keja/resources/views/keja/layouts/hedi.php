...
.btn-close {
    background: transparent url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23ffd54b'%3e%3cpath d='M.293.293a1 1 0 011.414 0L8 6.586 14.293.293a1 1 0 111.414 1.414L9.414 8l6.293 6.293a1 1 0 01-1.414 1.414L8 9.414l-6.293 6.293a1 1 0 01-1.414-1.414L6.586 8 .293 1.707a1 1 0 010-1.414z'/%3e%3c/svg%3e") center/1em auto no-repeat;
             ...
             .lmsapp-account-label{
            height: 220px;
        }
        .lmsapp-package-label{
            height: 250px;
        }
         .lmsapp-plan-text{
            font-size: .8rem;
...
[data-theme="dark"] .alert-close {
  background: transparent url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23242644'%3e%3cpath d='M.293.293a1 1 0 011.414 0L8 6.586 14.293.293a1 1 0 111.414 1.414L9.414 8l6.293 6.293a1 1 0 01-1.414 1.414L8 9.414l-6.293 6.293a1 1 0 01-1.414-1.414L6.586 8 .293 1.707a1 1 0 010-1.414z'/%3e%3c/svg%3e") center/1em auto no-repeat;
}
...
.alert-close{
  background: transparent url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23242644'%3e%3cpath d='M.293.293a1 1 0 011.414 0L8 6.586 14.293.293a1 1 0 111.414 1.414L9.414 8l6.293 6.293a1 1 0 01-1.414 1.414L8 9.414l-6.293 6.293a1 1 0 01-1.414-1.414L6.586 8 .293 1.707a1 1 0 010-1.414z'/%3e%3c/svg%3e") center/1em auto no-repeat;
    ...
    border: 1px solid #ffaf00!important;
           ...
           .lmsapp-card:active,.lmsapp-card:focus {
...
.lmsapp-border-primary{
    border: 1px solid #0dcaf0!important;
}
.lmsapp-border-secondary{
    border: 1px solid #ffaf00!important;
}
    .lmsapp-round{
        border-radius: 30px;
...
/*    padding: 10px 20px 10px 20px!important;*/
   ...
   .lmsapp-btn-primary:hover,.lmsapp-btn-primary:focus {
   background: #0dcaf0!important;
   color: #fff!important;
   box-shadow: 0 3px 5px #777777, inset 0 0 10px #777777;
   }
   .lmsapp-btn-primary:active {
   background: #0dcaf0!important;
   color: #fff!important;
   transform: scale(0.98);
   }

       .lmsapp-btn-secondary {
    border-radius: 30px;
...
/*    padding: 10px 20px 10px 20px!important;*/
   ...
   .lmsapp-btn-secondary:hover,.lmsapp-btn-secondary:focus {
   background: #ffaf00!important;
   color: #fff!important;
   box-shadow: 0 3px 5px #777777, inset 0 0 10px #777777;
   }
   .lmsapp-btn-secondary:active {
   background: #ffaf00!important;
   color: #fff!important;
   transform: scale(0.98);
   }

     .lmsapp-btn-outline-primary {
    border-radius: 30px;
    border: 2px solid #0dcaf0!important;
...
/*    padding: 10px 20px 10px 20px!important;*/
   ...
   .lmsapp-btn-outline-primary:hover,.lmsapp-btn-outline-primary:focus {
   background: #0dcaf0!important;
   color: #fff!important;
   box-shadow: 0 3px 5px #777777, inset 0 0 10px #777777;
   }
   .lmsapp-btn-outline-primary:active {
   background: #0dcaf0!important;
   color: #fff!important;
   transform: scale(0.98);
   }

     .lmsapp-btn-outline-secondary {
    border-radius: 30px;
    border: 2px solid #ffaf00!important;
    background: transparent;!important;
...
/*    padding: 10px 20px 10px 20px!important;*/
   ...
   .lmsapp-btn-outline-secondary:hover,.lmsapp-btn-outline-secondary:focus {
   background: #ffaf00!important;
   color: #fff!important;
   box-shadow: 0 3px 5px #777777, inset 0 0 10px #777777;
   }
   .lmsapp-btn-outline-secondary:active {
   background: #ffaf00!important;
   color: #fff!important;
   transform: scale(0.98);
   }
    ...
    font-size: 12px;
     ...
     <div class="header-area" id="headerArea">
      <div class="container-fluid h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="back-button"><a href="javascript:void();" onclick="window.history.go(-1); return false;">
        ...
        <div class="page-heading">
          <h6 class="mb-0"><a class="text-site" href="{{url('/')}}">LMS</a></h6>
        </div>
        
        <div class="lmsapp-navbar-toggler" data-bs-toggle="offcanvas" data-bs-target="#toggleSideNav" aria-controls="toggleSideNav"><span></span><span></span><span></span></div>
      </div>
    </div> 
