...
@section('title') Create {{$building->name}} Income @endsection
@section('content')
...
@include('layouts.toastr')
        ...
        <div class="box box-body">
            ...
            <form class="form-horizontal form-bordered" action="{{ route('storeBuildingIncome') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-1">Income Amount</label>
   ...
   <div class="table-responsive">
    ...
    <h5 style="font-weight: bold; font-size: 12px;"><i class="fa fa-book"></i> | Explore All {{$building->name}} Income  <i class="fa fa-money"></i> Report  </h5>
