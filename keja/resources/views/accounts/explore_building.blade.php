...
<div class="container-fluid">
   ...
   <div class="card shadow-lg keja-round mb-3">
      <div class="card-body">
         <?php 
            $buidling_rooms = Room::where(
                "building_id",
                "=",
                $building->id
            )->get(); 
            ?>
         <h6 class="mb-3 text-center">{{$building->name}} 3D Rooms</h6>
         <div class="row justify-content-center">
            @foreach($buidling_rooms as $room)
            <div class="col-md-3 mb-3">
               <div class="card @if(isset($room->lease)) bg-primary  @else bg-dark  @endif keja-popup-card keja-round h-100">
      ...
      <div class="card shadow-lg keja-round mb-3">
         <div class="card-body">
            <div class="container table-responsive-sm">
               ...
               <h6 class="text-center mb-3"> Expected Rent, Deductions & Payout Summary For The Month: {{$payoutMonth}}</h6>
            ...
            <div class="modal-content keja-bg">
               ...
               <div class="modal-body">
                  <div class="form-group">
                     <label for="commission_rate" class="control-label">Commssion Update</label>
                     <input required="" 
                        type="number"
                        name="commission_rate"
                        class="form-control text-site"
