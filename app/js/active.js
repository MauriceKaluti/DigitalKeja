(function () {
    ...
    var faxbarWindow = $(window);

    // :: Preloader
    faxbarWindow.on('load', function () {
    ...
    // :: Dropdown Menu
    $(".sidenav-nav").find("li.faxbar-dropdown-menu").append("<div class='dropdown-trigger-btn'><i class='lni lni-chevron-down'></i></div>");
    ...
    // :: Tooltip 
    var tooltipFxBar = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
    var tooltipList = tooltipFxBar.map(function (tooltip) {
        return new bootstrap.Tooltip(tooltip);
    });

    // :: Toast 
    var toastFxBar = [].slice.call(document.querySelectorAll('.toast'));
    var toastList = toastFxBar.map(function (toast) {
